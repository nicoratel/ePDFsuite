...
with tab2:
    ...
    with col_files2:
        ...
        #st.markdown("---")
        st.info("💡 **PONI files** contain geometric calibration data of the camera. They can be obtained using [perform_geometric_calibration](https://github.com/nicoratel/ePDFsuite/blob/main/Camera_Calibration_readME.md) function from ePDFsuite from diffraction data of a polycrystalline standard specimen (e.g., Au, Si).\n")
